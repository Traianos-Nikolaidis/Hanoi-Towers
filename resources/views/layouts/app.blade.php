        ...
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                @auth
                    ...
                    @endif
                    @if (Auth::user()->isSuperAdmin() || Auth::user()->isAdmin() || Auth::user()->isProfessor())
                        <li style="padding-right: 30px;" class="nav-item">
                            <a class="nav-link" href="{{ route('quiz.create') }}">Create Quiz</a>
                        </li>
                    @endif
                    <li style="padding-right: 30px;" class="nav-item">
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{ route('change-password.form') }}">Change Password</a>
